...
<template>
  <div class="arrowDiv">
    ...
    <button class="arrow" :key="3" :disabled="isIlegal(0, 1)" @click="SwitchWindow(0, 1)">↓</button>
    <button class="arrow" :key="4" :disabled="isIlegal(1, 0)" @click="SwitchWindow(1, 0)">→</button>
  </div>
</template>
